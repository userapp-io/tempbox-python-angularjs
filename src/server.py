...
class FileUploadHandler(tornado.web.RequestHandler):
    ...
    def post(self):
        ...
        try:
            ...
            user_upload_dir_path = config.UPLOAD_DIR_PATH + "/" + self.user_id
            ...
            if 'uploadedFile' in self.request.files:
                ...
                result = {'file_url': config.ABSOLUTE_UPLOAD_PATH + "/" + self.user_id + "/" + filename}
            else:
            ...
            if os.path.exists(user_upload_dir_path):
                for filename in os.listdir(user_upload_dir_path):
                    if os.path.isfile(os.path.join(user_upload_dir_path, filename)):
                        result.append({
                            'file_url':config.ABSOLUTE_UPLOAD_PATH + "/" + self.user_id + "/" + filename,
